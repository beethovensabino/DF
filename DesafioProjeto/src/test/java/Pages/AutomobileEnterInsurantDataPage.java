...
public class AutomobileEnterInsurantDataPage{
    ...
    public void setFirsName() {
        driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/form/div/section[2]/div[1]/input")).sendKeys("Nome");
    }
    ...
    public void setCity(){
        driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/form/div/section[2]/div[8]/input")).sendKeys("Itaporanga");
    }
    ...
    public void setWebsite(){
        driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/form/div/section[2]/div[11]/input")).sendKeys("www.google.com");
    }
    //@Test
