...
public class Auto_01_PreencherFormularioECadastrarAutomobile {
    ...
    public void euSelecionarUmaDasOpcoesPresentesNaAbaSelectPriceOptionEPressionarNext() throws InterruptedException {
    ...
    public void oSistemaRetornaQueOEMailFoiEnviadoComSucesso() throws InterruptedException {
        AutomobileSendQuotePage sendQuotePage = new AutomobileSendQuotePage(driver);
